...
export default function WelcomeGetStartedPage() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gradient-to-br from-primary/5 via-background to-background p-4 sm:p-6 text-center">
      <div className="flex-grow flex flex-col items-center justify-center">
        <div className="space-y-6 max-w-lg w-full">
          ...
          <Card className="bg-card/80 backdrop-blur-sm shadow-lg rounded-xl text-left animate-in fade-in-0 slide-in-from-bottom-8 duration-700 delay-200">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-foreground">Consents & Permissions</CardTitle>
              ...
              <div className="p-3 border rounded-lg bg-muted/30">
               ...
               <div className="flex items-start space-x-2 p-3 border-l-4 border-blue-500 bg-blue-500/10 rounded-r-lg">
                  ...
                  <p className="text-xs text-blue-700">
                      By proceeding, you consent to information collection as described in our Privacy Policy.
                  </p>
              </div>
            </CardContent>
          </Card>
