...
export default function OnboardingStep4Page() {
  return (
    <main className="relative flex flex-col min-h-screen bg-white overflow-hidden p-4">
      ...
      <div className="relative w-full h-[55vh] sm:h-[50vh] md:h-[48vh] bg-sky-500 rounded-t-[3rem] shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1),_0_-20px_15px_-10px_rgba(0,0,0,0.08)] flex flex-col">
