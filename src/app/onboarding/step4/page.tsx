    ...
    <main className="relative flex flex-col min-h-screen bg-white overflow-hidden">
      <div className="flex-grow flex flex-col items-center justify-center text-center pt-8 sm:pt-12 px-4 sm:px-6 md:px-8">
        <div 
          ...
          style={{ filter: 'drop-shadow(0px 0px 35px rgba(14,165,233,0.35))' }} // Sky Blue glow
        >
          <ShieldCheck className="h-20 w-20 sm:h-24 sm:h-24 md:h-28 md:w-28 text-sky-500" strokeWidth={1.5}/>
        </div>
      </div>

      <div className="relative w-full bg-sky-500 rounded-t-[3rem] shadow-[-10px_-10px_30px_rgba(0,0,0,0.07)] text-white flex flex-col"
          ...
          <div className="pb-2 text-center mt-auto">
            ...
            <div className="flex items-center w-full max-w-xs mx-auto gap-x-2">
                ...
                <Link href="/onboarding/step5" passHref className="flex-1">
                    <Button variant="default" size="sm" className="font-body bg-white hover:bg-white/90 text-sky-600 shadow-md rounded-lg w-full h-10 sm:h-11 text-xs sm:text-sm group">
