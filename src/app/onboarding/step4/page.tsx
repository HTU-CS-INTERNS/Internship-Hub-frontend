    ...
    <main className="relative flex flex-col min-h-screen bg-white overflow-hidden">
      <div className="flex-grow flex flex-col items-center justify-center text-center pt-8 sm:pt-12 px-4 sm:px-6 md:px-8">
        <div 
          ...
          style={{ filter: 'drop-shadow(0px 10px 30px rgba(14,165,233,0.25))' }} // Sky Blue glow
        >
          <Image 
      ...
      <div className="relative w-full bg-sky-500 rounded-t-[3rem] shadow-[-10px_-10px_30px_rgba(0,0,0,0.07)] text-white flex flex-col mt-8"
