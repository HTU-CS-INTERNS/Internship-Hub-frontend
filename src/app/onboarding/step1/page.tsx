  ...
  return (
    <main className="relative flex flex-col min-h-screen bg-background overflow-hidden p-4">
      ...
      <div className="relative w-full h-[45vh] sm:h-[40vh] md:h-[35vh] z-10 flex flex-col items-center justify-end">
        ...
        <div className="relative z-10 p-6 pb-4 text-center text-primary-foreground w-full max-w-md mx-auto mb-[calc(2rem+16px)]"> {/* mb to account for pagination dots + button */}
      ...
      {/* Navigation Footer (Dots and Skip Button) */}
