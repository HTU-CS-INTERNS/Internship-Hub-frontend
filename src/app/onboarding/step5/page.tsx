  ...
  return (
    <main className="relative flex flex-col min-h-screen bg-white overflow-hidden">
      <div className="flex-grow flex flex-col items-center justify-center text-center pt-8 sm:pt-12 px-4 sm:px-6 md:px-8">
        ...
        >
          <Rocket className="h-20 w-20 sm:h-24 sm:h-24 md:h-28 md:w-28 text-primary" strokeWidth={1.5}/>
        </div>
      </div>
      
      <div className="relative w-full bg-primary rounded-t-[3rem] shadow-[-10px_-10px_30px_rgba(0,0,0,0.07)] text-primary-foreground flex flex-col"
          ...
          <div className="pb-2 text-center mt-auto">
            ...
            <div className="flex items-center w-full max-w-xs mx-auto gap-x-2">
                <Link href="/onboarding/step4" passHref className="flex-1">
                    <Button variant="link" size="sm" className="font-body text-primary-foreground/80 hover:text-primary-foreground rounded-lg w-full h-10 sm:h-11 text-xs sm:text-sm group">
                ...
                <Link href="/register" passHref className="flex-1">
                    <Button className="font-body text-sm sm:text-base bg-primary-foreground hover:bg-primary-foreground/90 text-primary shadow-lg rounded-lg w-full group h-11 sm:h-12">
